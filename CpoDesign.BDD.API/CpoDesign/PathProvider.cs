...
namespace CpoDesign.BDD.API.CpoDesign
{
    ...
    {
        public static string LoadTemplateData(string templateFile)
        {
        ...
        public static bool CheckTemplateFolderExists()
        {
        ...
        public static string GetTemplatePathIfExists(string templateFileName)
        {
            string templateDirectory = GetTemplateDirectoryPath();
